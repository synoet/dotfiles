# Generated by Powerlevel10k configuration wizard on 2022-01-18 at 22:48 EST.
...
# 12h time, 2 lines, disconnected, no frame, sparse, many icons, concise,
...
() {
  ...
  # POWERLEVEL9K_ikDIR_CLASSES allows you to specify custom icons and colors for different
  ...
  typeset -g POWERLEVEL9K_ASDF_NODEJS_FOREGROUND=3
  ...
  ##########[ nodenv: node.js version from nodenv (https://github.com/nodenv/nodenv) ]##########
  # Nodenv color.
  typeset -g POWERLEVEL9K_NODENV_FOREGROUND=3
  ...
  ############[ nodeenv: node.js environment (https://github.com/ekalinin/nodeenv) ]############
  # Nodeenv color.
  typeset -g POWERLEVEL9K_NODEENV_FOREGROUND=6
  ...
  ##############################[ node_version: node.js version ]###############################
  # Node version color.
  typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND=6
  ...
  ###[ package: name@version from package.json (https://docs.npmjs.com/files/package.json) ]####
  # Package color.
  typeset -g POWERLEVEL9K_PACKAGE_FOREGROUND=7
